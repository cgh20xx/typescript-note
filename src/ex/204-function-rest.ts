...
// 這樣寫會出現錯誤：
const nums2 = [1, 2, 3];
// calculate2(...nums2); // error: A spread argument must either have a tuple type or be passed to a rest parameter.
...
const nums4 = [1, 2, 3] as [number, number, number];
calculate2(...nums4);

// 補充：as const 用於物件，會將物件的屬性都轉換為 readonly
// 型別：const people: {
//   readonly name: "hank";
//   readonly age: 40;
// }
